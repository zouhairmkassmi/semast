...
public class SemastApp {

    private static final Logger log = LoggerFactory.getLogger(SemastApp.class);

    private final Environment env;

    public SemastApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SemastApp.class);
